...
import { Box, Settings, Zap, Check, X, MessageCircle, Download, Layers, Eye, Printer, Cuboid, Scan, ChevronDown, FileText, Maximize2, ExternalLink } from 'lucide-react';
...
const Print3D = () => {
  ...
  return (
    <div className="font-sans bg-gray-50 min-h-screen relative overflow-x-hidden selection:bg-brand-primary selection:text-white">
      ...
      {/* --- 1. HERO SECTION (DISEÑO SLICER/SCANNER QUE TE GUSTÓ) --- */}
      <section 
        ref={heroRef}
      ...
      >
        <div className="absolute inset-0 flex items-end justify-center pointer-events-none overflow-hidden">
           <div className="iso-grid w-[200vw] h-[200vh] absolute top-1/2 -left-1/2"></div>
        </div>
        ...
        <div className="absolute inset-0 z-0 pointer-events-none">
           <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-brand-primary to-transparent blur-[2px] animate-scan absolute shadow-[0_0_20px_#22d3ee]"></div>
        </div>
        ...
        <div className="relative z-20 text-center px-6 max-w-5xl mx-auto">
          ...
          >
             ...
             <div className="px-3 py-1 rounded border border-brand-primary/30 bg-brand-primary/5 text-brand-primary text-xs font-bold tracking-widest uppercase">
               Manufactura Digital
             </div>
             <div className="h-[1px] w-12 bg-gray-700"></div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="relative inline-block py-10 px-8 md:px-16 border-x border-white/10"
          >
             ...
             <h1 className="text-6xl md:text-8xl font-extrabold text-white leading-none tracking-tight mb-4">
               IMPRESIÓN <span className="text-transparent bg-clip-text bg-gradient-to-b from-brand-primary to-blue-600">3D</span>
             </h1>
             <p className="text-gray-400 text-sm md:text-lg font-bold tracking-widest uppercase">
               Prototipado • Manufactura • Escaneado
             </p>
          </motion.div>
          ...
          >
            Materializamos tus ideas capa por capa. Desde prototipos de ingeniería hasta producción final con la máxima precisión del mercado.
          </motion.p>
          ...
          >
             <button onClick={() => openWhatsapp('Cotización 3D')} className="group px-8 py-4 bg-brand-primary text-[#0B0F19] font-bold text-lg rounded-xl hover:bg-white transition-all flex items-center gap-2 shadow-lg shadow-cyan-500/20">
                <Printer size={20} /> Cotizar Modelo
             </button>
             <a href="#galeria" className="group px-8 py-4 border border-gray-600 text-white font-medium text-lg rounded-xl hover:border-brand-primary hover:text-brand-primary transition-all backdrop-blur-sm">
                Ver Trabajos
             </a>
          </motion.div>
      ...
      <section className="py-24 bg-[#0F1420] border-t border-white/5 relative">
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="text-center mb-16">
             <h2 className="text-3xl md:text-4xl font-bold text-white mb-2">Ingeniería de Materiales</h2>
             <p className="text-gray-400">Seleccionamos el polímero exacto para tu necesidad.</p>
          </div>
      ...
      {/* --- 3. GALERÍA SCROLLABLE (DISEÑO RESTAURADO: Split Menu + Glass + Effects) --- */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-4 sticky top-24 z-10">
              ...
              {/* Caja de Ayuda (Blue Glass) */}
              <div className="mt-6 bg-blue-50/80 backdrop-blur-md rounded-2xl p-6 border border-blue-100 hidden lg:block">
                <h4 className="font-bold text-brand-primary mb-2 flex items-center gap-2"><Scan size={18}/> ¿Tienes un modelo 3D?</h4>
                <p className="text-sm text-brand-primary/80 mb-4">Si tienes tu archivo .STL o .OBJ, lo cotizamos al instante.</p>
                <button 
                  onClick={() => openWhatsapp('Tengo archivo STL')}
                  className="w-full bg-brand-primary hover:bg-brand-dark text-white font-bold py-3 rounded-lg text-sm transition-colors shadow-lg shadow-blue-200"
                >
                  Enviar Archivo
                </button>
              </div>
            ...
            {/* COLUMNA DERECHA: CONTENIDO Y GALERÍA (Restaurado) */}
            <div className="lg:col-span-8">
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 h-[700px] flex flex-col">
                  ...
                  <div className="overflow-y-auto custom-scrollbar pr-2 flex-grow">
                    ...
                    <p className="text-center text-gray-400 text-xs mt-2">Mostrando {activeCategory.images.length} imágenes disponibles.</p>
                  </div>
              </div>
            </div>
      ...
      {/* --- 4. SECCIÓN PDF (DISEÑO RESTAURADO: Tarjeta Oscura Premium) --- */}
      <section className="py-20 px-6 bg-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto bg-[#1a1825] rounded-[2.5rem] p-10 md:p-16 shadow-2xl relative overflow-hidden border border-white/5">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center relative z-10">
            {/* Texto */}
            <div>
              <div className="inline-block bg-brand-accent text-white text-xs font-bold px-3 py-1 rounded-full mb-6 shadow-lg shadow-orange-500/20">
                RECURSO GRATUITO
              </div>
              <h2 className="text-4xl md:text-5xl font-bold text-white mb-6 leading-tight">
                Catálogo Técnico & <br/> <span className="text-brand-accent">Lista de Precios</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a 
                  ...
                  className="flex items-center justify-center gap-3 bg-white text-brand-dark font-bold py-4 px-8 rounded-xl hover:bg-gray-100 transition-all shadow-lg hover:-translate-y-1"
                >
                  <Download size={22} className="text-brand-primary" />
                  Descargar PDF
                </a>
                <a 
                  href="/catalogo3d.pdf"
                  ...
                  className="flex items-center justify-center gap-3 border border-gray-600 text-gray-300 font-bold py-4 px-8 rounded-xl hover:border-white hover:text-white transition-all"
                >
            ...
            <div className="relative group">
              <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-2 shadow-2xl border border-gray-700 transform group-hover:scale-[1.02] transition-transform duration-500">
                <div className="bg-gray-900 rounded-t-xl px-4 py-3 flex items-center gap-2 border-b border-gray-700">
                  ...
                  <div className="ml-4 bg-gray-800 px-3 py-1 rounded text-xs text-gray-400 flex items-center gap-2 w-full max-w-[200px]">
                    <FileText size={10} /> catalogo_3d_2026.pdf
                  </div>
                </div>

                <div className="bg-white h-[400px] w-full rounded-b-xl overflow-hidden relative">
                   <iframe 
                      src="/catalogo3d.pdf#toolbar=0" 
                      title="Visor Catálogo"
                      className="w-full h-full"
                    >
                      <div className="flex flex-col items-center justify-center h-full text-gray-500">
                        <FileText size={48} className="mb-2" />
                        <p>Tu navegador no soporta la previsualización.</p>
                      </div>
                    </iframe>
                    ...
                    <a 
                      href="/catalogo3d.pdf" 
                      target="_blank"
                      className="absolute bottom-4 right-4 bg-black/80 text-white p-2 rounded-lg hover:bg-brand-primary transition-colors backdrop-blur-sm"
...
const MaterialCard = ({ title, desc, badge, color, bg }) => (
  <div className="bg-[#151b2b] border border-white/5 p-6 rounded-xl hover:border-brand-primary/30 transition-all group">
    <div className="flex justify-between items-start mb-4">
       <div className={`p-2 rounded bg-white/5 ${color}`}><Layers size={24}/></div>
       <span className="text-xs font-bold text-gray-500 uppercase tracking-wide">{badge}</span>
    </div>
    <h3 className="text-lg font-bold text-white mb-2 group-hover:text-brand-primary transition-colors">{title}</h3>
