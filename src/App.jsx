  ...
  return (
    <BrowserRouter>
      ...
      <a 
        ...
        className="fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20bd5a] text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 hover:shadow-[#25d366]/40 flex items-center justify-center group"
        title="Contáctanos por WhatsApp"
      >
        <svg viewBox="0 0 24 24" width="32" height="32" fill="currentColor" className="animate-pulse">
